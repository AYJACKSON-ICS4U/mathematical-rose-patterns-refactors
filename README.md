# Mathematical Rose Pattern Refactors
...
The refactors for each individual can be found in a folder in this repo that corresponds with their name. Currently, none of these refactors have a web environment and thus can only be accessed via a localhost or live server on your machine.
